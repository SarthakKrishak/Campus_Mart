  ...
  return (
    ...
    >
      ...
      <div className="hidden items-center text-[1.9vw] sm:flex gap-8 md:gap-7 lg:gap-11 font-medium xl:gap-14">
        ...
        <Link
          to="/"
          className="hover:text-blue-500 transition duration-200 md:text-[1.6vw] lg:text-[1.7vw] xl:text-[1.2vw] font-poppins font-medium"
        >
          Orders
        </Link>
        <Link
          to="/"
          className="hover:text-blue-500 transition duration-200 lg:text-[1.7vw] xl:text-[1.2vw] font-poppins md:text-[1.6vw]"
        >
          Chats
        </Link>
        <Link
