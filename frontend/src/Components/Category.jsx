...
const Category = ({ title, imageSrc }) => {
  return (
    <div
      className={`lg:min-w-[20vw] xl:min-w-[16vw] md:min-w-[22vw] min-w-[35vw] h-10 md:h-10 lg:h-12 flex lg:justify-between justify-between items-center pl-4 pr-4 lg:rounded-lg rounded-md shadow-[inset_5px_-7px_21.299999237060547px_0px_rgba(57,79,241,0.10)] border border-neutral-200 hover:shadow-sm bg-white lg:pl-7 xl:pl-10 md:pl-6 hover:scale-105 duration-700 ease-in-out`}
    >
