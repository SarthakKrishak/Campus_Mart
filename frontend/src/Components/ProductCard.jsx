  ...
  return (
    <div className="w-[17vw] h-[52vh] rounded-lg overflow-hidden border border-slate-300 shadow-lg shadow-gray-200">
      ...
      <div className="flex gap-2 pl-2">
        <div className="bg-slate-200 border border-slate-300 px-2 py-1 rounded-sm text-sm font-medium">
          Light
        </div>
        <div className="bg-[#394FF1] text-white px-2 py-1 rounded-sm text-sm font-medium shadow-md">
          Electronics
        </div>
      </div>
