...
const ProductDescription = () => {
  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="flex flex-col w-full xl:flex-row 2xl:min-h-screen">
        <Toaster />
        {/* left side */}
        <div className="w-full mt-3 flex flex-col items-center xl:items-start gap-4 xl:w-1/3 xl:ml-5">
          {/* left top */}
          <div className="rounded-2xl shadow-[0px_3.691620111465454px_12px_0px_rgba(102,102,102,0.10)] border pb-1 object-contain bg-white w-[93vw] xl:flex flex-col justify-center md:items-center xl:items-start xl:w-[28vw]">
            <img
              className="w-96 pl-5 pr-5 pt-3 rounded-xl xl:w-[30vw] md:mx-auto lg:mx-auto"
              src="/assets/pro_desc.png"
              alt="image"
            />
            <div className="flex pl-5 pb-3 pt-1 justify-between xl:w-full">
              <div className="flex gap-3 mt-2 md:mx-auto lg:mx-auto">
                <img
          ...
          {/* Left side bottom */}
          <div className="hidden xl:block ml-1 w-[37vw] p-5 rounded-2xl shadow-lg shadow-slate-200 border xl:w-[28vw]">
        ...
        {/* Right side */}
        <div className="flex flex-col justify-between w-[93vw] ml-3 lg:ml-9 md:ml-7 mt-4 lg:mt-3 xl:ml-1 xl:mr-5 xl:w-3/4">
          {/* Right top side */}
          <div className="flex flex-col rounded-2xl shadow-lg shadow-slate-200 border pl-6 pr-6 pb-6 pt-5 w-full">
            <div className="flex justify-between items-center pr-4">
              <div className=" text-blue-600/80 bg-zinc-100 rounded-md w-28 md:w-36 md:py-2 py-[1vh] flex justify-center items-center font-semibold md:text-base text-sm font-robotoFlex">
                Electronics
              </div>
            ...
            <div className="flex flex-col">
              <h1 className="text-[5.5vw] text-neutral-900 font-bold mt-5 md:text-[3vw] lg:text-[2.7vw] xl:text-[1.8vw] font-robotoFlex">
              ...
              <div className="text-[8vw] flex items-center mt-1 md:text-[5vw] lg:text-[3.8vw] xl:text-[2.8vw]">
                ...
                <div className="text-zinc-600 flex items-center text-xl md:text-2xl justify-end ml-3 mt-3 font-normal line-through font-poppins leading-none">
                  <IndianRupee className="size-4" />
                  <h1>599</h1>
                </div>
              </div>

              <h1 className="font-semibold md:font-medium mt-4 text-base md:text-lg xl:mt-7 font-poppins">
                Product Details
              </h1>
            ...
            <div className="flex flex-col mt-8 gap-6 md:flex-row md:gap-36 lg:gap-32 xl:gap-64">
              <div className="flex flex-col gap-2">
                <h1 className="font-medium text-[#828F9B] text-base md:text-base">
                  Condition
                </h1>
                <div className="flex flex-col gap-2">
            ...
            <div className="bg-[#f5faff] pt-4 pb-4 mt-6 rounded-md md:mt-3 pl-4">
              ...
              <p className="w-52 text-[#2D3339] font-medium text-sm leading-5 md:leading-7 md:text-base md:w-64 font-robotoFlex">
